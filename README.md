...
| src/browser\_automation.py |       68 |       16 |       12 |        0 |     80% |   115-142 |
| src/constants.py           |        9 |        0 |        0 |        0 |    100% |           |
| src/exceptions.py          |        1 |        0 |        0 |        0 |    100% |           |
| src/form\_submission.py    |       20 |        0 |        0 |        0 |    100% |           |
| src/main.py                |       42 |       42 |        2 |        0 |      0% |      1-69 |
| src/scraper.py             |      164 |       13 |       56 |        6 |     90% |129-130, 136, 145, 149, 169->167, 174, 205-206, 253-258 |
|                  **TOTAL** |  **304** |   **71** |   **70** |    **6** | **78%** |           |
